...
public class FilmDAO {
	...
	/**
	 * GET method which retrieves a single Film using the id from the database using a prepared statement and populates the oneFilm Film object with the
	 * result. The DatabaseConnectionSingleton class is used to establish a connection to the database. If an SQLException occurs, it will be caught
	 * and printed to the console. Finally, the prepared statement and connection are closed.
	...
	public Film getFilmByID(int id){
		...
		try {
		    ...
		    prepStmt = conn.createPreparedStatement(selectSQL);
