...
public class Film {
	/** private int variable that holds the id of the film */	
	private int id;
	/** private String variable that holds the title of the film */
	private String title;
	/** private int variable that holds the year of the film */
	private int year;
	/** private String variable that holds the director of the film */
	private String director;
	/** private String variable that holds the stars of the film */
	private String stars;
	/** private String variable that holds the review of the film */
	...
	/** Retrieves a string representation of the Film object
